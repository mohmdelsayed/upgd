...
class Plotter:
    ...
    def plot(self):
        ...
        for style, color, subdir in zip(styles, colors, self.best_runs_path):
            ...
            if not 'fully_connected_relu_with_hooks' in subdir:
                self.avg_interval = 20000
            else:
                self.avg_interval = 4
...
if __name__ == "__main__":
    ...
    #     'logs/ex7_label_permuted_mnist/sgd/fully_connected_relu_with_hooks/lr_0.01_weight_decay_0.0001',
    #     'logs/ex7_label_permuted_mnist/pgd/fully_connected_relu_with_hooks/lr_0.01_sigma_0.005',
    #     'logs/ex7_label_permuted_mnist/upgd_fo_global/fully_connected_relu_with_hooks/lr_0.01_beta_utility_0.9_sigma_0.001_weight_decay_0.0',
    ...
    #     'logs/ex9_label_permuted_mini_imagenet/sgd/fully_connected_relu_with_hooks/lr_0.01_weight_decay_0.001',
    #     'logs/ex9_label_permuted_mini_imagenet/pgd/fully_connected_relu_with_hooks/lr_0.01_sigma_0.005',
    #     'logs/ex9_label_permuted_mini_imagenet/upgd_fo_global/fully_connected_relu_with_hooks/lr_0.01_beta_utility_0.9_sigma_0.001_weight_decay_0.0',
    ...
    best_runs1 = [
        'logs/ex6_input_permuted_mnist/upgd_fo_global/fully_connected_relu/lr_0.001_beta_utility_0.999_sigma_0.0_weight_decay_0.0001', # zero perturbation
        'logs/ex6_input_permuted_mnist/upgd_fo_global/fully_connected_relu/lr_0.001_beta_utility_0.999_sigma_0.0001_weight_decay_0.0', # zero decay
        'logs/ex6_input_permuted_mnist/upgd_fo_global/fully_connected_relu/lr_0.001_beta_utility_0.999_sigma_0.0_weight_decay_0.0', # zero perturbation + zero decay    
        'logs/ex6_input_permuted_mnist/sgd/fully_connected_relu_with_hooks/lr_0.001_weight_decay_0.001',
        'logs/ex6_input_permuted_mnist/pgd/fully_connected_relu_with_hooks/lr_0.001_sigma_0.05',
        'logs/ex6_input_permuted_mnist/upgd_fo_global/fully_connected_relu_with_hooks/lr_0.01_beta_utility_0.9999_sigma_0.1_weight_decay_0.01',
