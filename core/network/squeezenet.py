# code from https://github.com/weiaicunzai/pytorch-cifar100/blob/master/models/squeezenet.py
...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, n_obs=10, n_outputs=100):
        ...
        self.conv10 = nn.Conv2d(512, n_outputs, 1)
