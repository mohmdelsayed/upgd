...
class NoisyOnlineEWC(torch.optim.Optimizer):
    def __init__(self, params, lr=1e-5, lamda=0.01, beta_weight=0.999, beta_fisher=0.999, sigma=1.0):
        names, params = zip(*params)
        defaults = dict(lr=lr, lamda=lamda, beta_weight=beta_weight, beta_fisher=beta_fisher, sigma=sigma, names=names)
        super(NoisyOnlineEWC, self).__init__(params, defaults)
