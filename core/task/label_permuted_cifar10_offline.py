...
class LabelPermutedCIFAR10Offline(Task):
    """
    ...
    def __init__(self, name="label_permuted_cifar10_offline", batch_size=1, change_freq=2500):
        self.dataset = self.get_dataset(train=True)
        self.original_targets = self.dataset.targets.copy()
        self.test_targets = self.get_dataset(train=False).targets.copy()
...
if __name__ == "__main__":
    task = LabelPermutedCIFAR10Offline()
